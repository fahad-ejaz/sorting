...
export default function SelectionSortGraph({unSortedArray, startSorting, isReset, setIsReset, isSorted, setIsSorted}) {
  ...
  useEffect(()=>{
    if (startSorting){
      ...
      selectionSort({arr:[...sortedArray], n:sortedArray.length, setSortedArray, setColors, setIsSorted, colors});
      // setIsSorted[1] = true;
